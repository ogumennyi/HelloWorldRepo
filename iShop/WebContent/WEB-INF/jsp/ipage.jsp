...
<table class="inner_table" border="1">
	<tr>
		<th width="150px" style="padding: 1x 2px">Product group (<a href="${pageContext.request.contextPath}/ipage">all</a>)</th>
	</tr>
	<tr>
		<td align="center">
			<div style="padding: 5px 2px">
				<c:forEach items="${groupsList}" var="group" varStatus="vs">
					...
					<div>
						<a href="${pageContext.request.contextPath}/ipage/${group.group_id}">
						<c:choose>
	...
	<tr>
		<c:choose>
			<c:when test="${empty productsList}">
				<td colspan=2 align="center"><div>No products in this group</div></td>
			</c:when>
			<c:otherwise>
				<td>
					<div style="padding: 5px 2px">
